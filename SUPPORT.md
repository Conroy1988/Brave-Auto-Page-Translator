...
1. Open the extension popup and read the exact status message.
2. Confirm privacy setup is complete.
3. Confirm the page is a normal HTTP or HTTPS webpage.
...
Feature requests should remain directly related to the extension's single purpose: translating webpage text. Unrelated browser tools will not be bundled into the extension.
